"""Validate ISY profile files and version sync for Hunter Douglas."""
...
ENTRY = ROOT / "udi-hunterdouglas-pg3x.py"

CONTROLLER_COMMANDS = {"QUERY", "DISCOVER", "REMOVE_NOTICES_ALL"}
CONTROLLER_NODEDEF = "hdctrl"
